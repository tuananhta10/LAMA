...
@Component({
  selector: 'care-reusable-grid-incident',
  animations: [mainAnimations],
  templateUrl: './reusable-grid-incident.component.html',
  styleUrls: ['./reusable-grid-incident.component.scss']
})
export class ReusableGridIncidentComponent implements OnInit {
  @Input() loading: any = {}
