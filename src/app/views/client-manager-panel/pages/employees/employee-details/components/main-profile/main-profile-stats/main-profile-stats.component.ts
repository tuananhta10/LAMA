  ...
  public statData: any[] = [
    {
      ...
      "view_more": () => this.router.navigate([`/staff/employees/details/${this.id}/employee-shift`])
    },
...

    {
      ...
      "view_more": () => this.router.navigate([`/staff/employees/details/${this.id}/timesheet`])
    },
    ...
    if(this.id){
      ...
      this.req = this.employee$.subscribe((result: any) => {
        ...
        if(employeeStats?.length > 0){
          this.statData[0]['stat_val'] = employeeStats[0]?.employee_service_schedule_total;
          this.statData[1]['stat_val'] = employeeStats[0]?.employee_service_schedule_cancel;
          this.statData[2]['stat_val'] = employeeStats[0]?.employee_qualification_percentage + ' %';
          this.statData[3]['stat_val'] = employeeStats[0]?.employee_timesheet_total_hours + ' H';
