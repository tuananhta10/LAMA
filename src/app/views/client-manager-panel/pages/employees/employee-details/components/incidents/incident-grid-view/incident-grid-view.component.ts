...
@Component({
  selector: 'app-incident-grid-view',
  animations: [mainAnimations],
  templateUrl: './incident-grid-view.component.html',
  styleUrls: ['./incident-grid-view.component.scss']
})
export class IncidentGridViewComponent implements OnInit {
  @Input() loading: any = {}
