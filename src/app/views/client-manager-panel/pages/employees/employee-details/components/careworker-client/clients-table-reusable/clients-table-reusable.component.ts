...
@Component({
  selector: 'employee-clients-table-reusable',
  animations: [mainAnimations],
  templateUrl: './clients-table-reusable.component.html',
  styleUrls: ['./clients-table-reusable.component.scss']
})
export class ClientsTableReusableComponent implements OnInit {
