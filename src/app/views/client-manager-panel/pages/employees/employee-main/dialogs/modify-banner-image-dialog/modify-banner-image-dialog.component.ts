...
import { EmployeeListBanner } from '../../utils/employee-list-model';
import { ImageCroppedEvent } from 'ngx-image-cropper';
import { base64ToFile,  } from 'ngx-image-cropper';
import { mainAnimations } from '@app-main-animation';

@Component({
  selector: 'employee-modify-banner-image-dialog',
...
export class ModifyBannerImageDialog implements OnInit {
  ...
  public selectedImage: EmployeeListBanner;
  ...
  constructor(public dialogRef: MatDialogRef<ModifyBannerImageDialog>,
    @Inject(MAT_DIALOG_DATA) public data: EmployeeListBanner) {
