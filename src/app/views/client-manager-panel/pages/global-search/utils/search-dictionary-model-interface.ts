...
export const global_search_object: Navigation[] = [
  ...
  {
    name: 'Clients',
    description: 'Clients Module Description Here',
    route: '/admin/clients'
  },

  /*{
    name: 'Clients Groups',
    description: 'Clients Groups Module Description Here',
    route: '/admin/clients/groups'
  },

  {
    name: 'Clients Service Providers',
    description: 'Clients Service Providers Module Description Here',
    route: '/admin/clients/groups'
  },*/

  {
    name: 'Client Service Schedule',
    description: 'Client Service Schedule Module Description Here',
    route: '/admin/clients/service-schedule'
  },

  /*{
    name: 'Client Service Calendar',
    description: 'Client Service Calendar Module Description Here',
...
*/
  ...
  {
    name: 'Client Checklist Setup',
    description: 'Client Checklist Setup Module Description Here',
...

  {
    ...
    description: 'Organization List Module Description Here',
