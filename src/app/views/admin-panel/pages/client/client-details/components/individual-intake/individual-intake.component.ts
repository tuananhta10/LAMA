...
@Component({
  selector: 'client-individual-intake',
  animations: [mainAnimations],
  templateUrl: './individual-intake.component.html',
  styleUrls: ['./individual-intake.component.scss']
})
export class IndividualIntakeComponent implements OnInit {
