...
export class ServiceDetailsComponent implements OnInit {
  ...
  public clientFundingColumns: any[] = [
    {title: 'Participant',col_name: 'name'},
    ...
    {title: 'Planned', col_name: 'allocated'}, 
  ...
  public clientGoalColumns: any[] = [
    ...
    {title: 'Goal Name', col_name: 'goal'}, 
    {title: 'Goal Type', col_name: 'goal_type'},
    {title: 'Description', col_name: 'description'},
    {title: 'Assigned To', col_name: 'employee_name'}, 
    {title: 'Duration', col_name: 'duration'}, 
    {title: 'Status', col_name: 'status'}, 
  ];
  public selectedClientGoalCol: any[] = this.clientGoalColumns.map(el => el?.col_name)
  public clientGoalData:any[] = [];
  
  public searchBy: string = '';
  public filteredClientFundingList: any[] = [];
  public filteredServiceTemplateList: any[] = [];
  public filteredPlanReviewList: any[] = [];
  public filteredClientGoalData: any[] = []
  ...
  subscribeClient(){
    ...
    this.req = client.subscribe((results: any) => {
      ...
      if(!this.loading){
        ...
        this.clientGoalData = results?.client?.serviceDetails['client_goals'] ? results?.client?.serviceDetails['client_goals'] : [];
        ...
        console.log("SERVICE DETAILS", results?.client?.serviceDetails)
        this.clientData = results?.client?.serviceDetails;
