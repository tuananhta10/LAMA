...
@Component({
  selector: 'admin-reusable-org-table',
  animations: [mainAnimations],
  templateUrl: './reusable-org-table.component.html',
  styleUrls: ['./reusable-org-table.component.scss']
})
export class ReusableOrgTableComponent implements OnInit {
