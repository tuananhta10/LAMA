...
import { AdminReferralsRoutes } from './referrals.routing';
...
import { AddCommentsComponent } from './referrals-main/dialogs/add-comments/add-comments.component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild(AdminReferralsRoutes)
  ],
  declarations: [
