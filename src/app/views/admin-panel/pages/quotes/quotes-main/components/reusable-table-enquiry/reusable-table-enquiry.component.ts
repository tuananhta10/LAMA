...
@Component({
  selector: 'app-reusable-table-enquiry',
  animations: [mainAnimations],
  templateUrl: './reusable-table-enquiry.component.html',
  styleUrls: ['./reusable-table-enquiry.component.scss']
})
export class ReusableTableEnquiryComponent implements OnInit {
