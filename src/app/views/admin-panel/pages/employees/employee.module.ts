...
import { PositionChangeModalComponent } from './employee-shared/modals/position-change-modal/position-change-modal.component';
import { CalculatedCostComponent } from './employee-timesheet-approval/forms/calculated-cost/calculated-cost.component';
import { GenerateEmployeeReportComponent } from './employee-main/dialogs/generate-employee-report/generate-employee-report.component';
import { GenerateTimesheetReportComponent } from './employee-timesheet-approval/dialogs/generate-timesheet-report/generate-timesheet-report.component';
import { FilterByEmployeeComponent } from './employee-timesheet-approval/dialogs/filter-by-employee/filter-by-employee.component';
import { FilterByEmployeeComponent as FilterByEmployeePositionComponent } from './employee-main/dialogs/filter-by-employee/filter-by-employee.component';
import { EmployeeBulkSmsNotificationComponent } from './employee-bulk-sms-notification/employee-bulk-sms-notification.component';
import { EmployeeBulkEmailNotificationComponent } from './employee-bulk-email-notification/employee-bulk-email-notification.component';
import { CKEditorModule } from 'ckeditor4-angular';
import { ProfileEmailInboxComponent } from './employee-details/components/profile-email-inbox/profile-email-inbox.component';
import { ProfileSmsInboxComponent } from './employee-details/components/profile-sms-inbox/profile-sms-inbox.component';
import { ProfileMainInboxSelectionComponent } from './employee-details/components/profile-main-inbox-selection/profile-main-inbox-selection.component';
import { AddProfileEmailComponent } from './employee-details/dialogs/add-profile-email/add-profile-email.component';
import { AddProfileSmsComponent } from './employee-details/dialogs/add-profile-sms/add-profile-sms.component';
import { DeleteArchiveItemComponent } from './employee-details/dialogs/delete-archive-item/delete-archive-item.component';
...
@NgModule({
    ...
    declarations: [
        ...
        GenerateTimesheetReportComponent,
        FilterByEmployeeComponent,
        FilterByEmployeePositionComponent,
        EmployeeBulkSmsNotificationComponent,
        EmployeeBulkEmailNotificationComponent,
        ProfileEmailInboxComponent,
        ProfileSmsInboxComponent,
        ProfileMainInboxSelectionComponent,
