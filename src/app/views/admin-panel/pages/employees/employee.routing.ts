...
export const AdminEmployeeRoutes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'employee-shift/cancelled', component: EmployeeShiftComponent },
      { path: 'timesheet', component: TimesheetApprovalComponent },

      { path: 'communication-feeds/inbox', component: ProfileMainInboxSelectionComponent },
      { path: 'communication-feeds/sent', component: ProfileMainInboxSelectionComponent },
      { path: 'communication-feeds/archive', component: ProfileMainInboxSelectionComponent },
    ]
  },
  { path: 'service-calendar', component: EmployeeServiceCalendarComponent },
  { path: 'employee-shift', component: MainEmployeeShift },
  { path: 'employee-shift/cancelled', component: MainEmployeeShift },
  ...
  { path: 'email-notifications', component: EmployeeBulkEmailNotificationComponent },
  { path: 'sms-notifications', component: EmployeeBulkSmsNotificationComponent },
];
