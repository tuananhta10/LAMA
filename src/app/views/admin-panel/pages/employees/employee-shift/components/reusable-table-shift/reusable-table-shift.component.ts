...
@Component({
  selector: 'employee-reusable-table-shift',
  animations: [mainAnimations],
  templateUrl: './reusable-table-shift.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ReusableTableShiftComponent),
      multi: true
    },
    { provide: DateAdapter, useClass: CustomDateAdapter }
  ],
  styleUrls: ['./reusable-table-shift.component.scss']
})
export class ReusableTableShiftComponent implements OnInit {
