...
@Component({
  selector: 'admin-employee-list-banner',
  animations: [mainAnimations],
  templateUrl: './employee-list-banner.component.html',
  styleUrls: ['./employee-list-banner.component.scss']
})
export class EmployeeListBannerComponent implements OnInit {
