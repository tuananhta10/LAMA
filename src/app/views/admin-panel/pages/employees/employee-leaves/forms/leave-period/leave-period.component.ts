...
export class LeavePeriodComponent implements OnInit {
  ...
  public leaveReason: string[] = ["Compassionate Leave", "Domestic Violence Leave", "Unpaid Leave", "Annual Leave", "Personal Leave", "Long Service Leave", "Maternity Leave", "Workers Comp", "Sick Leave"].sort((a,b) => a?.localeCompare(b));
