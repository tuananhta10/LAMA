...
@Component({
  selector: 'employee-reusable-table-leaves',
  animations: [mainAnimations],
  templateUrl: './reusable-table-leaves.component.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ReusableTableLeavesComponent),
      multi: true
    },
    { provide: DateAdapter, useClass: CustomDateAdapter }
  ],
  styleUrls: ['./reusable-table-leaves.component.scss']
})
export class ReusableTableLeavesComponent implements OnInit {
