...
export class UnderstandingNeedsComponent implements OnInit {
  ...
  understandingNeedForm!: FormGroup;
  ...
  ngOnInit(): void {
    this.understandingNeedForm = this.formBuilder.group({
      ...
      lama_workers_support: this.formBuilder.array(this.understandingNeedData ? this.understandingNeedData?.lama_workers_support : []),
